class Score:
    ...
    def __eq__(self, score2):
        return self.total() == score2.total()

    def __gt__(self, score2):
        return self.total() > score2.total()

    def __lt__(self, score2):
        return self.total() < score2.total()

    def __ge__(self, score2):
        return self.total() >= score2.total()

    def __ne__(self, score2):
        return self.total() != score2.total()

    def __le__(self, score2):
        return self.total() <= score2.total()

    def __add__(self, score2):
        return Score(self.goals + score2.goals, self.points + score2.points)

    def __sub__(self, score2):
        return Score(self.goals - score2.goals, self.points - score2.points)

    def __iadd__(self, score2):
        self.goals += score2.goals
        self.points += score2.points
        return self
