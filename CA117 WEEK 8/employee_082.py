class Employee:
    ...
    def __init__(self, name, employee_number=0, hourly_rate=9.25, hours_worked=0.00):
        self.name = name
    ...
    def __str__(self):
        return "Name: {}\nID: {}\nHours: {:.2f}\nRate: {:.2f}\nWages: {:.2f}".format(self.name, self.employee_number, self.hours_worked, self.hourly_rate, self.wages())

    def add_hours(self, time):
        self.hours_worked += time

    def wages(self):
        wage = self.hourly_rate * self.hours_worked
        return wage
